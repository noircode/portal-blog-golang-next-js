...
func RunServer() {
	...
	// FE
	feApp := api.Group("/fe")
	feApp.Get("/category", categoryHandler.GetCategoryFE)
	feApp.Get("/content", contentHandler.GetContentWithQuery)
	feApp.Get("/content/:contentID", contentHandler.GetContentDetail)
